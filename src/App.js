...
// Import the new component that shows recent orders
  ...
  const togglemode = () => {
    if (mode === "light") {
      ...
      document.body.style.background =
        "linear-gradient(300deg, #00bbf0, #00204a, #fdb44b)";
      ...
      setmode("light");
      document.body.style.background =
        "linear-gradient(300deg, #66bfbf, #eaf6f6, #f76b8a)";
      document.body.style.backgroundSize = "180% 180%";
      document.body.style.animation = "gradient-animation 18s ease infinite";
    ...
    <Router>
      ...
      <div className="container my-5">
        <Routes>
          ...
          {/* Updated route to use OrdersList component */}
          <Route
            exact
            path="/orders"
            element={<OrdersList showAlert={showAlert} />}
          />

          <Route
            exact
            path="/shop-list"
            element={<ShopList showAlert={showAlert} />}
          />
          <Route
            exact
            path="/confirmation"
            element={<Confirmation showAlert={showAlert} />}
          />
        </Routes>
      </div>
    </Router>
